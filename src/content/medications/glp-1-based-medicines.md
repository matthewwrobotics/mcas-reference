---
name: GLP-1-based medicines
aliases: ["GLP-1s", "GLP-1 receptor agonists", "GLP-1RAs", "semaglutide", "tirzepatide"]
summary: Incretin-based drug class with a 47-person retrospective MCAS case series; no randomised MCAS comparison or established direct human mast-cell mechanism.
mechanismClass: GLP-1-receptor agonists and dual GIP/GLP-1-receptor agonists
mastCellBasis: mcas-patients
studyDesigns:
  - case-series
  - case-report
establishedFor:
  - condition: "chronic weight management in obesity or overweight (specific formulations)"
    basis: approved-us
  - condition: "obstructive sleep apnea in adults with obesity (tirzepatide)"
    basis: approved-us
specialistUse:
...
citations:
  - title: "Utility of glucagon-like-peptide-1-receptor agonists in mast cell activation syndrome"
    url: "https://pubmed.ncbi.nlm.nih.gov/40675372/"
    sourceType: peer-reviewed
    year: 2025
    pmid: "40675372"
    accessed: 2026-08-21
  - title: "Improvement of Chronic Spontaneous Urticaria After Glucagon-Like Peptide 1 Receptor Agonist Therapy: Report of Two Cases"
    url: "https://pubmed.ncbi.nlm.nih.gov/41535531/"
    sourceType: peer-reviewed
    year: 2026
    pmid: "41535531"
    accessed: 2026-08-21
  - title: "Wegovy (semaglutide) current US prescribing information"
    url: "https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=ee06186f-2aa3-4990-a760-757579d8f77b"
    sourceType: drug-label
    accessed: 2026-08-21
  - title: "Zepbound (tirzepatide) current US prescribing information"
...
The approval rows are formulation-specific examples, not a class-wide approval statement. The current semaglutide and tirzepatide labels include major contraindications and warnings, and their use for MCAS remains off-label.
